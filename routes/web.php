...
$app->get("/vote", function() use ($app) {
   ...
   $artworks = [
      ["id" => 0, "name" => "La Joconde", "author" => "Léonard de Vinci", "date" => "1940", "description" => "un magnifique tableau sur toile de léonard", "image" => "https://upload.wikimedia.org/wikipedia/commons/thumb/e/ec/Mona_Lisa,_by_Leonardo_da_Vinci,_from_C2RMF_retouched.jpg/260px-Mona_Lisa,_by_Leonardo_da_Vinci,_from_C2RMF_retouched.jpg"],
   ...
   $args = [
      "sessionDescription" => "Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! Coucou ! C'est le musée ! Votez pour l'œvre que vous aimeriez voir lors de la prochaine expo !! ",

      "fromDate" => "01/02/2017", // temporaire, la date ne devrai pas être une chaîne
      "toDate"   => "28/02/2017",
